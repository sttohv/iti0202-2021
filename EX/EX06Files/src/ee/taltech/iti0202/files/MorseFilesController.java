...
public class MorseFilesController {
    ...
    public static void main(String[] args) {
        ...
        translator.addMorseCodes(List.of("a tere", "b on", "c cunt"));

        System.out.println(translator.translateLinesToMorse(List.of("ab", "c")));
        System.out.println(translator.addMorseCodes(List.of("a tere", "b on", "c cunt")));
