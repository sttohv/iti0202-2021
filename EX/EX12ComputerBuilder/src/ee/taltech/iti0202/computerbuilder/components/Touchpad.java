...
public class Touchpad extends Component {
    /**
     ...
     */
    public Touchpad(String name, Type type, double price, String manufacturer, int performancePoints, int powerConsumption) {
